...
public class HomePage {
    ...
    // Additional method to check if the online product link is displayed
    public static boolean isOnlineProductLinkDisplayed() {
        return driver.findElement(By.xpath(onlineProduct_link_xpath)).isDisplayed();
    }
}
